...
///
/// ```no_run
/// # let context = skw_contract_sdk::test_utils::VMContextBuilder::new().build();
/// # let vm_config = skw_contract_sdk::VMConfig::test();
/// # let fees_config = skw_contract_sdk::RuntimeFeesConfig::test();
/// # let storage = Default::default();
/// # let validators = Default::default();
/// let mocked_blockchain = skw_contract_sdk::MockedBlockchain::new(
///           context,
///           vm_config,
///           fees_config,
///           vec![],
...
///           None,
///       );
/// skw_contract_sdk::env::set_blockchain_interface(mocked_blockchain);
/// ```
#[cfg(not(target_arch = "wasm32"))]
