...
use crate::crypto::key_conversion::convert_secret_key;
use crate::crypto::key_file::KeyFile;
...
pub trait Signer: Sync + Send {
    ...
    fn compute_vrf_with_proof(&self, _data: &[u8]) -> (crate::crypto::vrf::Value, crate::crypto::vrf::Proof);
...
impl Signer for InMemorySigner {
    ...
    fn compute_vrf_with_proof(&self, data: &[u8]) -> (crate::crypto::vrf::Value, crate::crypto::vrf::Proof) {
