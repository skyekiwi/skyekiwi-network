...
#[derive(BorshSerialize, BorshDeserialize, Serialize, Deserialize, Hash, Clone, Debug, PartialEq, Eq)]
...
#[derive(Default, Clone, PartialEq, Debug, BorshSerialize, BorshDeserialize)]
...
pub type ReceiptResult = Vec<Receipt>;
