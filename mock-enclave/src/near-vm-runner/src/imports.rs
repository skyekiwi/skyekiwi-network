...
// let mut env_builder = EnvironmentDefinationBuilder::new();
// fn env_method_name(e: &mut State, args: &[Value]) -> Result<ReturnValue, HostError> {
...
//     Ok(ReturnValue::Value(Value::I32(e.member as i32)));
// }

// env_builder.add_host_func("env", "method_name", method_name);
// ....

// let mut instance = Instance::new(code, &env_builder, &mut state);
// let result = instance.invoke("exported_name", args, &mut state);
